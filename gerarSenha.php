<?php 
    require_once 'configDB.php'; #Para usar o banco de dados
    $msg = "";
    if(isset($_GET['email']) && isset($_GET['token'])){
        ...
        $sql = $conexão->prepare("SELECT * FROM usuario WHERE "
                . "email=? AND token=? AND tokenExpirado > now()");
        ...
        }else{#e-mail ou token inválidos
          ...
          <section class="row justify-content-center">
              <div class="col-lg-5 mt-5">
                  ...
                  <form method="post"> <!--envio para propria pagina--> 
                      ...
                      <div class="form-group">
                          <input type="submit" value="Cadastrar senha" class="btn btn-block 
                                 btn-primary" name="gerar">
                      </div>                       
